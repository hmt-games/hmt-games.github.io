...
You can jump on the game and play at any time from **July 1, 2025** to **July 31, 2025**. The AI agent will be online on **July 1, 2025**. In-person and virtual match making events will be hosted on **July 18, 2024** and **July 24, 2024**. 
The game supports two play modes --- the *practice* mode and the *competition* mode. In the *practice* mode (released in March, 2025), you can switch between the three characters to get familiar with the game. The *competition* mode will only be available at matchmaking events.
...
We will be organizing a series of in-person and virtual matchmaking events. Please [sign up here](https://gatech.co1.qualtrics.com/jfe/form/SV_eqx6QQeMWPEqREO) to get registered.
...
### July 18 Matchmaking Schedule

In-person location: [Tech Square Research Building](https://maps.app.goo.gl/dAX792juvRYqwb4fA) Room 204
Address: 85 5th St NW, Atlanta, GA 30332

Please go on the second floor. If you take the elevator, walk straight to your right. If you use the stairs, turn right and then go straight.
Room 204 has a glass door and is opposite to the printing area.
